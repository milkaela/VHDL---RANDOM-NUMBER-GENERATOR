...
#
# Script generated by Vivado on Wed Dec 17 16:57:52 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_random.sh
...
#
# Usage        : design_random.sh
#                design_random.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_random.sh [-reset_run]
#                design_random.sh [-reset_log]
#                design_random.sh [-help]
#
...
# script info
echo -e "design_random.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_random.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_random xil_defaultlib.design_random xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_random -key {Behavioral:sim_1:Functional:design_random} -tclbatch cmd.tcl -protoinst "protoinst_files/design_random.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_random.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_random.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_random.sh [-help]\n\
Usage: design_random.sh [-step]\n\
Usage: design_random.sh [-lib_map_path]\n\
Usage: design_random.sh [-reset_run]\n\
Usage: design_random.sh [-reset_log]\n\
Usage: design_random.sh [-keep_index]\n\
Usage: design_random.sh [-noclean_files]\n\n\
