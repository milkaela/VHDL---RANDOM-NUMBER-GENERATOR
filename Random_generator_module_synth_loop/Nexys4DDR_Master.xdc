set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports clk_port]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports en0_port]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports en1_port]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports out_port]
...
## Clock signal
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk_port]
