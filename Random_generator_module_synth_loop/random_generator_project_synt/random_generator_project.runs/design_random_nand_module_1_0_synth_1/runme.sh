...
HD_PWD='C:/Users/Octa476/Desktop/Random_generator_module/random_generator_project/random_generator_project.runs/design_random_nand_module_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_random_nand_module_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_random_nand_module_1_0.tcl
