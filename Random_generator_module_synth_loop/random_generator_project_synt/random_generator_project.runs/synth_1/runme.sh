...
HD_PWD='C:/Users/Octa476/Desktop/Random_generator_module_synth/random_generator_project_synt/random_generator_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_random_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_random_wrapper.tcl
