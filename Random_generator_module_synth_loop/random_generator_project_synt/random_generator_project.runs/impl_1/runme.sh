...
HD_PWD='C:/Users/Octa476/Desktop/Random_generator_module_synth/random_generator_project_synt/random_generator_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_random_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_random_wrapper.tcl -notrace
